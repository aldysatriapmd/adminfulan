                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" action="<?=base_url('A_user/update_data_user')?>" enctype="multipart/form-data">
                                <input type="hidden" name="idnya" value="<?=$data['id']?>">
                                <input type="hidden" name="fotonya" value="<?=$data['foto']?>">
                                ...
                                <div class="form-group"><label class="col-md-3 control-label">Tanggal Lahir</label>
                                    <div class="col-md-9"><input type="date" name="lahir" value="<?=$data['tgl_lahir']?>" id="lahir" class="form-control" required> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-md-3 control-label">Foto</label>
                                    <div class="col-md-9">
                                        ...
                                        *input foto jika ingin mengganti foto
                                    </div>
                                </div>
