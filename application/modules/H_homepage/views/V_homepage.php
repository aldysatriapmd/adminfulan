...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.3/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Dec 2015 00:57:55 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="<?=base_url()?>sets/inspinia/font-awesome/css/font-awesome.min.css" rel="stylesheet">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a class="page-scroll" href="#features">Beranda</a></li>
                        <li><a class="page-scroll" href="#team">Info Perpustakaan</a></li>
...
<section id="features" class="container services">
    <div class="row" style="margin-top: 100px;">
                <div class="input-group">
                    <input type="text" placeholder="Search" class=" form-control" style="height: 80px;font-size: 25px;border-color: #1C84C6;border-width: 10px;"> 
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-sm btn-primary" style="height: 80px;background-color: #1c84c6;border-color: #1c84c6;"> Go!</button> 
                        </span>
                </div>
    </div>
    <div class="row" style="margin-top: 80px">
        <div class="col-sm-3">
            <h2>Buku Terbaru</h2>
            <i class="fa fa-book big-icon pull-right"></i><br>
            <p>Berikut daftar buku terbaru pada bulan ini</p>
            <p><a class="navy-link" href="#" role="button">Details &raquo;</a></p>
        </div>
        <div class="col-sm-3">
            <h2>Buku Terpopuler</h2>
            <i class="fa fa-book big-icon pull-right"></i><br>
            <p>Buku yang baik adalah buku yang menarik minat untuk membacanya</p>
            <p><a class="navy-link" href="#" role="button">Details &raquo;</a></p>
        </div>
        <div class="col-sm-3">
            <h2>Buku Edisi Terbatas</h2>
            <i class="fa fa-book big-icon pull-right"></i><br>
            <p>Buku buku ini hanya tersedia dalam jumlah sedikit</p>
            <p><a class="navy-link" href="#" role="button">Details &raquo;</a></p>
        </div>
        <div class="col-sm-3">
            <h2>Buku Agama</h2>
            <i class="fa fa-book big-icon pull-right"></i><br>
            <p>Semua buku adalah ilmu tapi tidak semua ilmu adalah ilmu agama</p>
            <p><a class="navy-link" href="#" role="button">Details &raquo;</a></p>
        </div>
    </div>
</section>
...
<script src="<?=base_url()?>sets/inspinia/js/bootstrap.min.js"></script>
<script src="<?=base_url()?>sets/inspinia/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="<?=base_url()?>sets/inspinia/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>

<!-- Custom and plugin javascript -->
<script src="<?=base_url()?>sets/inspinia/js/inspinia.js"></script>
<script src="<?=base_url()?>sets/inspinia/js/plugins/pace/pace.min.js"></script>
<script src="<?=base_url()?>sets/inspinia/js/plugins/wow/wow.min.js"></script>
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.3/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Dec 2015 00:58:53 GMT -->
</html>
